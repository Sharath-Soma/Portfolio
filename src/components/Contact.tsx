      ...
      <div className="max-w-[1280px] mx-auto w-full px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-8 lg:gap-[64px] items-start">
            ...
            <div className="w-full flex flex-col gap-[20px]">
              ...
              <div className="w-full flex flex-col gap-[20px]">
                ...
                <a
                  ...
                  className="bg-[#FFFFFF] border border-[#E5E0D8] rounded-3xl p-5 sm:p-6 shadow-premium hover:border-[#D97745]/50 hover:shadow-premium-hover card-hover-effect hover:-translate-y-1.5 flex items-start gap-4 group block w-full"
                >
                ...
                {/* Location Card */}
                <div className="bg-[#FFFFFF] border border-[#E5E0D8] rounded-3xl p-5 sm:p-6 shadow-premium flex items-start gap-4 w-full">
              ...
              {/* Social Connect Card */}
              <div className="bg-[#FFFFFF] border border-[#E5E0D8] rounded-3xl p-5 sm:p-6 shadow-premium w-full">
          ...
          <Reveal width="100%" delay={0.2}>
            <div className="w-full bg-[#FFFFFF] border border-[#E5E0D8] rounded-3xl p-6 sm:p-8 shadow-premium">
              <form onSubmit={handleSubmit} className="w-full flex flex-col gap-[20px]">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-[20px] w-full">
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F8F5EF] border border-[#E5E0D8] rounded-2xl px-4 py-3.5 text-sm text-[#222222] placeholder:text-[#A09A90] focus:outline-none focus:border-[#D97745] focus:ring-2 focus:ring-[#D97745]/50 transition-colors font-sans"
                    />
                  </div>
                ...
                <div className="w-full">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full bg-[#F8F5EF] border border-[#E5E0D8] rounded-2xl px-4 py-3.5 text-sm text-[#222222] placeholder:text-[#A09A90] focus:outline-none focus:border-[#D97745] focus:ring-2 focus:ring-[#D97745]/50 transition-colors font-sans resize-none"
                  />
                </div>
